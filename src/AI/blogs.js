const blogs = [
    ...
    {
        "id": 2,
        "title": "Финансиска независност: Како да ја постигнете?",
    ...
    {
        "id": 3,
        "title": "Иднината на вештачката интелигенција",
    ...
    {
        "id": 4,
        "title": "Најсмешните моменти од секојдневниот живот",
    ...
    {
        "id": 5,
        "title": "Тајните на среќната врска",
    ...
    {
        "id": 6,
        "title": "Криптовалути: Дали се исплати да инвестирате?",
    ...
    {
        "id": 8,
        "title": "Зошто Македонците имаат најдобар хумор?",
    ...
    {
        "id": 10,
        "title": "Како да заштедите пари на патувања?",
    ...
    {
        "id": 13,
        "title": "Паметни градови: Како технологијата го менува урбаното живеење?",
