...
export default function TableReservation() {
  ...
  const [inactiveTables, setInactiveTables] = React.useState([
    't1',
    't2',
    't4',
    't7',
  ...
  const renderTableChairs = () => (
    <>
      <div
        style={{ top: '.4rem', left: '-1rem', transform: 'rotate(-45deg)' }}
      />
      <div
        style={{ top: '.4rem', right: '-1rem', transform: 'rotate(45deg)' }}
      />
      <div
        style={{ bottom: '.4rem', right: '-1rem', transform: 'rotate(-45deg)' }}
      />
      <div
        style={{ bottom: '.4rem', left: '-1rem', transform: 'rotate(45deg)' }}
      />
    </>
  );
      ...
      <div>
        <TablesMap>
          <div>
            <Table
              id={'t1'}
              className={inactiveTables.includes('t1') ? 'inactive' : ''}
            >
              4-6
              {renderTableChairs()}
            </Table>
            <Table
              id={'t2'}
              className={inactiveTables.includes('t2') ? 'inactive' : ''}
            >
              4-6
              {renderTableChairs()}
            </Table>
            <Table
              id={'t3'}
              className={inactiveTables.includes('t3') ? 'inactive' : ''}
            >
              4-6
              {renderTableChairs()}
            </Table>
            <Table
              id={'t4'}
              className={inactiveTables.includes('t4') ? 'inactive' : ''}
            >
              4-6
              {renderTableChairs()}
            </Table>
          ...
          <div>
            <Table
              id={'t5'}
              className={inactiveTables.includes('t5') ? 'inactive' : ''}
            >
              4-6
              {renderTableChairs()}
            </Table>
            <Table
              id={'t6'}
              className={inactiveTables.includes('t6') ? 'inactive' : ''}
            >
              2-4
              {renderTableChairs()}
            </Table>
            <Table
              id={'t7'}
              className={inactiveTables.includes('t7') ? 'inactive' : ''}
            >
              2-4
              {renderTableChairs()}
            </Table>
            <Table
              id={'t8'}
              className={inactiveTables.includes('t8') ? 'inactive' : ''}
            >
              2-4
              {renderTableChairs()}
            </Table>
          ...
          <div>
            <Table
              id={'t9'}
              className={inactiveTables.includes('t9') ? 'inactive' : ''}
            >
              4-6
              {renderTableChairs()}
            </Table>
            <Table
              id={'t10'}
              className={inactiveTables.includes('t10') ? 'inactive' : ''}
            >
              2-4
              {renderTableChairs()}
            </Table>
            <Table
              id={'t11'}
              className={inactiveTables.includes('t11') ? 'inactive' : ''}
            >
              2-4
              {renderTableChairs()}
            </Table>
            <Table
              id={'t12'}
              className={inactiveTables.includes('t12') ? 'inactive' : ''}
            >
              4-6
              {renderTableChairs()}
            </Table>
