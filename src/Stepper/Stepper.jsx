...
function StepIndicator({ step, currentStep, onClickStep, disableStepIndicators }) {
  ...
  return (
    <motion.div onClick={handleClick} className="step-indicator" animate={status} initial={false}>
      <motion.div
        variants={{
          inactive: { scale: 1, backgroundColor: "var(--logo-red)", color: "#a3a3a3" },
          active: { scale: 1, backgroundColor: "var(--logo-red)", color: "#00d8ff" },
          complete: { scale: 1, backgroundColor: "var(--logo-red)", color: "white" },
        }}
        transition={{ duration: 0.3 }}
        className="step-indicator-inner"
      >
